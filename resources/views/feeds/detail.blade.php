    ...
    <div class="dashboard">
        ...
        <div class="card">
            <div class="image-container">
                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-sm-6">
                        <figcaption class="figure-caption custom-caption-left" style="text-align:left; padding:20px">
                            Written by: Shoko Ieri, Geto Suguru</figcaption>
                    </div>
                    <div class="col-sm-6 text-right">
                        <figcaption class="figure-caption custom-caption-right" style="text-align:right; padding:20px">
