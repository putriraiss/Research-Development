    ...
    <div class="container">
      <div class="col-span-1">
        <div style="display: flex; align-items: center;">
          <h3 class="title" style="text-align: left; margin-left: 8px; font-family: 'Poppins', sans-serif; color: black; font-weight:bold;color:#4f4f4f;">Projects</h3>
          <img src="../assets/foto/new-add.png" alt="" style="margin-left: auto; margin-top: -35px; right: 30px;width:30px;height:30px;">
        </div>
        <ul class="cards">
          <li class="card">
            <div style="width: 100%; margin-left: 8px;">
              <div class="card-content">
                ...
                <h4 class="card-title" style="color:#4f4f4f; margin-top: 15px">Environment Impact Mitigation</h4>
              </div>
            </div>
          ...
          <li class="card">
            <div style="width: 100%; margin-left: 8px;">
              <div class="card-content">
                <div class="badge badge-primary badge-outline" style="color:orange; margin-top:15px;">On Risk</div>
          ...
          <li class="card">
            <div style="width: 100%; margin-left: 8px;">
              <div class="card-content">
                <div class="badge badge-primary badge-outline" style="color:red; margin-top:15px;">Off Track</div>
                <h4 class="card-title" style="color:#4f4f4f; margin-top: 15px">Underground Infrastructure</h4>
              </div>
            </div>
            <div class="card-link-wrapper" style="display: flex; align-items: center;">
              <img src="../assets/foto/menu-dot.png" alt="" style="margin-left: auto; margin-top: 0; position: absolute; top: 19px; right: 30px;">
      ...
      <div class="col-span-2" style="margin-left: 30px; margin-right: 15px;">
        ...
        <h3 class="title" style="text-align: left; font-family: 'Poppins', sans-serif; font-weight:bold;color:#4f4f4f;">Environment Impact Mitigation</h3>
        <p id="project-manager" style="margin-top: -20px; margin-bottom:5px; font-size:15px;color:#4f4f4f;font-weight:500;">General Manager Choi Yeonjun</p>
        <div style="display: flex; align-items: center;">
        ...
        <div style="display: flex; align-items: center;">
          ...
          <img src="../assets/foto/new-add.png" alt="" style="margin-left: auto; margin-right:15px;margin-top: 20px; right: 30px;width:30px;height:30px;">
        </div>
          ...
          <div class="dashboard">
            <div class="container">
              <div class="card card-tengah" style="position: relative;">
                <div style="width: 100%;">
                  <div class="card-content">
                    <div class="badge badge-primary" style="background-color: #BF5C1C;color: #FFFFFF;margin-top:15px;margin-left:10px;margin-bottom:15px">Research</div>
                    <h4 class="card-title" style="color:#4f4f4f;margin-left:10px;font-size:20px;">Infrastructure Development.</h4>
                    <div class="container" style="display:flex;text-align:right;align-content:right;margin-left:0;">
                      <div style="display:flex; width:100%;align-content:left;text-align:left;align-items:left;">
                        <img src="../assets/foto/calendar-icon.png" alt="" style="margin-left: auto; width:20px; height:20px;">
                        <p id="cal-date" style="margin-bottom: 5px; font-size: 15px; margin-left: 5px;margin-right:15px;">Nov 21</p>
                        <img src="../assets/foto/chat-notif.png" alt="" style="text-align:left;margin-left: 5px;width:20px; height:20px;">
                        <p id="chat-pro" style="margin-bottom: 5px; font-size: 15px; margin-left: 5px;margin-right:15px;">2</p>
                        <img src="../assets/foto/pin.png" alt="" style="margin-left: 5px;width:20px; height:20px;">
                        <p id="pin-pro" style="margin-bottom: 5px; font-size: 15px; margin-left: 5px;margin-right:15px;">2</p>
                        <img src="../assets/foto/list.png" alt="" style="margin-left: 5px;width:20px; height:20px;">
                        <p id="list-pro" style="margin-bottom: 5px; font-size: 15px; margin-left: 5px;margin-right:32px;">6/6</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card card-tengah" style="position: relative;">
                <div style="width: 100%;">
                  <div class="card-content">
                    <div class="badge badge-primary" style="background-color: #BF5C1C;color: #FFFFFF;margin-top:15px;margin-left:10px;margin-bottom:15px">Developer</div>
                    <h4 class="card-title" style="color:#4f4f4f;margin-left:10px;font-size:20px;">Marketing page redesigning.</h4>
                    <div class="container" style="display:flex;text-align:right;align-content:right;margin-left:0;">
                      <div style="display:flex; width:100%;align-content:left;text-align:left;align-items:left;">
                        <img src="../assets/foto/calendar-icon.png" alt="" style="margin-left: auto; width:20px; height:20px;">
                        <p id="cal-date" style="margin-bottom: 5px; font-size: 15px; margin-left: 5px;margin-right:15px;">Sep 12</p>
                        <img src="../assets/foto/empty-chat.png" alt="" style="text-align:left;margin-left: 5px;width:20px; height:20px;">
                        <p id="chat-pro" style="margin-bottom: 5px; font-size: 15px; margin-left: 5px;margin-right:15px;">0</p>
                        <img src="../assets/foto/pin.png" alt="" style="margin-left: 5px;width:20px; height:20px;">
                        <p id="pin-pro" style="margin-bottom: 5px; font-size: 15px; margin-left: 5px;margin-right:15px;">0</p>
                        <img src="../assets/foto/list.png" alt="" style="margin-left: 5px;width:20px; height:20px;">
                        <p id="list-pro" style="margin-bottom: 5px; font-size: 15px; margin-left: 5px;margin-right:31px;">1/5</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="col-span-1" style="margin-left: 10px; margin-right: -35px;">
        <!-- TEAM MEMBER -->
        <div style="display: flex; align-items: center;">
          <h3 class="title" style="text-align: left; font-family: 'Poppins', sans-serif; font-weight:bold;color:#4f4f4f;">Team Members</h3>
          <img src="../assets/foto/user-add.png" alt="" style="margin-left: auto; margin-right:15px;margin-top: -25px; right: 30px;width:30px;height:30px;">
        </div>
        <div class="overflow-x-auto">
              ...
              <tr>
                <td>
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <div class="font-bold" style="font-size: 20px; font-family: 'Poppins', sans-serif; color: #4f4f4f;">Choi Yeonjun</div>
              ...
              <tr>
                <td>
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <div class="font-bold" style="font-size: 20px; font-family: 'Poppins', sans-serif; color: #4f4f4f;">Choi Soobin</div>
              ...
              <tr>
                <td>
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <div class="font-bold" style="font-size: 20px; font-family: 'Poppins', sans-serif; color: #4f4f4f;">Akaso Eiji</div>
              ...
              <tr>
                <td>
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <div class="font-bold" style="font-size: 20px; font-family: 'Poppins', sans-serif; color: #4f4f4f;">Hiro Hamada</div>
                      <div class="text-sm opacity-50">Developer, Web Designer, Research</div>
                    </div>
                  </div>
                </td>
          ...
          <!-- TASK STATUS -->
          <h3 class="title" style="margin-top:35px;text-align: left; font-family: 'Poppins', sans-serif; font-weight:bold;color:#4f4f4f;">Task Status</h3>
          <div class="overflow-x-auto">
            <table class="table">
              <tbody>
                <!-- row 1 -->
                <tr>
                  <td>
                    <div class="flex items-center gap-3">
                      ...
                      <div class="font-bold" style="font-size:18px;">Infrastructure Development.</div>
                    </div>
                    <div style="display: flex; align-items: center; gap: 10px; margin-top: -5px; margin-bottom: 5px;"> <!-- Menambahkan margin-top agar progress terletak di bawah tulisan -->
                ...
                <tr>
                  <td>
                    <div class="flex items-center gap-3">
                      ...
                      <div class="font-bold" style="font-size:18px;">Marketing Page Redesign.</div>
                    </div>
                    <div style="display: flex; align-items: center; gap: 10px; margin-top: -5px; margin-bottom: 5px;"> <!-- Menambahkan margin-top agar progress terletak di bawah tulisan -->
